...
class TestManageShowsTab():
    ...
    def test_user_see_show_card_content(self, driver):
    ...
    def test_search_show_by_status(self, driver, filter):
        self.link = base_url + "/ones/new/shows"
        page = ShowsPage(driver, self.link)
        page.open()
    ...
    def test_user_opens_manage_show_page(self,driver):
        self.link = base_url + "/ones/new/shows"
        page = ShowsPage(driver, self.link)
        page.open()
        page.find_max_qty_of_lines_in_focus_top()
    ...
    def test_user_opens_ones_page(self, driver):
        self.link = base_url + "/ones/new/shows"
        page = ShowsPage(driver, self.link)
        page.open()
        page.find_max_qty_of_lines_in_focus_top()
    ...
    def test_user_opens_financial_page(self, driver):
        self.link = base_url + "/ones/new/shows"
        page = ShowsPage(driver, self.link)
        page.open()
        page.find_max_qty_of_lines_in_focus_top()
    ...
    def test_user_creates_new_show(self, driver):
        self.link = base_url + "/ones/new/shows"
        page = ShowsPage(driver, self.link)
        page.open()
    ...
    def test_necessary_tabs_displaying_manage_show(self, driver):
        self.link = base_url + "/ones/new/shows"
        page = ShowsPage(driver, self.link)
        page.open()
        page.find_max_qty_of_lines_in_focus_top()
    ...
    def test_necessary_tabs_displaying_create_show(self, driver):
        self.link = base_url + "/ones/new/shows"
        page = ShowsPage(driver, self.link)
        page.open()
        page.open_create_show_page()   
    ...
    def test_create_empty_show_notification_displaying(self, driver):
        self.link = base_url + "/ones/new/shows"
        page = ShowsPage(driver, self.link)
        page.open()
        page.open_create_show_page() 
